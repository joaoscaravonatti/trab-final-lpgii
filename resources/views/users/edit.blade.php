...
@section('title', 'Editar usuário')
    <form method="POST" action="{{ route('users.update') }}" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input id="father_name" class="form-control" type="text" name="father_name" required value="{{ $user->father_name }}" />
            </div>
        </div>
        <div class="form-group row">
            <label for="mother_name" class="col-md-3 col-form-label text-md-right">Nome da Mãe</label>
            <div class="col-md-9">
                <input id="mother_name" class="form-control" type="text" name="mother_name" required value="{{ $user->mother_name }}" />
            </div>
        </div>
        <div class="form-group row">
            <label for="date_of_birth" class="col-md-3 col-form-label text-md-right">Data de Nascimento</label>
            <div class="col-md-9">
                <input id="date_of_birth" class="form-control" type="date" name="date_of_birth" required value="{{ $user->date_of_birth }}" />
            </div>
        </div>
        <div class="form-group row">
            <label for="register" class="col-md-3 col-form-label text-md-right">Matrícula</label>
            <div class="col-md-9">
                <input id="register" class="form-control" type="text" name="register" required value="{{ $user->register }}" />
            </div>
        </div>
        <div class="form-group row">
